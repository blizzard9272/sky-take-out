...
public class WorkspaceServiceImpl implements WorkspaceService {
    ...
    public BusinessDataVO getBusinessData(LocalDateTime begin, LocalDateTime end) {
        ...
        // 输出日志
        log.info("营业数据统计：begin={}, end={}, totalOrderCount={}, turnover={}, validOrderCount={}, orderCompletionRate={}, unitPrice={}, newUsers={}",
                begin, end, totalOrderCount, turnover, validOrderCount, orderCompletionRate, unitPrice, newUsers);
